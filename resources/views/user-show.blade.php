...
<body>
    ...
    <div class="container">
        <h2 class="m-2"><strong>User Details Page</strong></h2>
        <div>
            <form action=" {{ url('user/show') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                {{--  <a href="{{ url('user/list/'.$user->id) }}" class="btn btn-primary">List</a>  --}}
            </form>
        </div>
    </div>
